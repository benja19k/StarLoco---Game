...
import org.starloco.locos.game.world.filter.PacketFilter;
...
public class GameHandler implements IoHandler {
    ...
    public void messageReceived(IoSession arg0, Object arg1) throws Exception {
        ...
        if (Config.INSTANCE.getEncryptPacket() && !packet.startsWith("AT") && !packet.startsWith("Ak")) {
    ...
    public void messageSent(IoSession arg0, Object arg1) throws Exception {
        ...
        if (client != null) {
            String packet = (String) arg1;
            if (Config.INSTANCE.getEncryptPacket() && !packet.startsWith("AT") && !packet.startsWith("HG"))
