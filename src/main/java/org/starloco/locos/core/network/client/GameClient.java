...
import org.starloco.locos.game.command.CommandAdmin;
import org.starloco.locos.game.command.CommandPlayer;
import org.starloco.locos.game.command.administration.AdminUser;
import org.starloco.locos.game.common.Formulas;
import org.starloco.locos.game.common.PathFinding;
...
import org.starloco.locos.game.entity.exchange.CraftSecure;
import org.starloco.locos.game.entity.exchange.Exchange;
import org.starloco.locos.game.entity.exchange.PlayerExchange;
import org.starloco.locos.game.entity.mount.Mount;
import org.starloco.locos.game.entity.npc.Npc;
import org.starloco.locos.game.entity.npc.NpcAnswer;
import org.starloco.locos.game.entity.npc.NpcQuestion;
import org.starloco.locos.game.entity.npc.NpcTemplate;
import org.starloco.locos.game.entity.pet.Pet;
...
import org.starloco.locos.game.fight.spells.Spell;
import org.starloco.locos.game.world.action.ExchangeAction;
import org.starloco.locos.game.world.action.GameAction;
...
import org.starloco.locos.game.hdv.HdvLine;
import org.starloco.locos.game.job.Job;
import org.starloco.locos.game.job.JobAction;
import org.starloco.locos.game.job.JobConstant;
import org.starloco.locos.game.job.JobStat;
import org.starloco.locos.game.job.maging.BreakingObject;
...
import org.starloco.locos.game.object.ObjectTemplate;
import org.starloco.locos.game.object.entity.Fragment;
import org.starloco.locos.game.object.entity.SoulStone;
import org.starloco.locos.game.other.Action;
import org.starloco.locos.game.other.Dopeul;
import org.starloco.locos.game.guild.Guild;
import org.starloco.locos.game.quest.Quest;
...
public class GameClient {
    ...
    private void authorisedCommand(String packet) throws InterruptedException {
        ...
        Loggers.command.info(this.getAccount().getCurrentIp() + " : " + this.getAccount().getName() + " > " + this.getPlayer().getName() + " > " + packet.substring(2));
    ...
    private void tchat(String packet) {
        ...
        switch (packet.charAt(2)) {
            ...
            case '*'://Defaut
                ...
                Loggers.tchat.info("Default" + this.player.getName() + " > Map " + this.player.getCurMap().getId() + " > " + msg);
            ...
            case '#'://Canal Equipe
                ...
                if (this.player.getFight() != null) {
                    ...
                    if (team == -1)
                        return;
                    Loggers.tchat.info("Team" + this.player.getName()
            ...
            case '$'://Canal groupe
                ...
                if (this.player.getParty() == null)
                    break;
                msg = packet.split("\\|", 2)[1];
                Loggers.tchat.info(("Party" + this.player.getName()
            ...
            case ':'://Canal commerce
                ...
                if (this.player.cantCanal()) {
                    ...
                    msg = packet.split("\\|", 2)[1];
                    Loggers.tchat.info(("Trade" + this.player.getName()
                                + " > " + msg));
                    if (this.player.getObjetByPos(Constant.ITEM_POS_ROLEPLAY_BUFF) != null)
                        if (this.player.getObjetByPos(Constant.ITEM_POS_ROLEPLAY_BUFF).getTemplate().getId() == 10844)
                            msg = Formulas.translateMsg(msg);
            ...
            case '@'://Canal Admin
                if (this.player.getGroupe() == null)
                    return;
                msg = packet.split("\\|", 2)[1];
                Loggers.tchat.info(("Admin " + this.player.getName()
                            + " > " + msg));
            ...
            case '?'://Canal recrutement
                ...
                if (this.player.cantCanal()) {
                    ...
                    msg = packet.split("\\|", 2)[1];
                    Loggers.tchat.info(("Recruitment"+ this.player.getName()
                                + " > " + msg));
                    if (this.player.getObjetByPos(Constant.ITEM_POS_ROLEPLAY_BUFF) != null)
                        if (this.player.getObjetByPos(Constant.ITEM_POS_ROLEPLAY_BUFF).getTemplate().getId() == 10844)
                            msg = Formulas.translateMsg(msg);
            ...
            case '%'://Canal guilde
                ...
                if (this.player.getGuild() == null)
                    return;
                msg = packet.split("\\|", 2)[1];
                Loggers.tchat.info(("Guild" + this.player.getName()
            ...
            case '!'://Alignement
                ...
                msg = packet.split("\\|", 2)[1];
                Loggers.tchat.info(("Align"+ this.player.getName()
                            + " > " + msg));
                if (this.player.getObjetByPos(Constant.ITEM_POS_ROLEPLAY_BUFF) != null)
                    if (this.player.getObjetByPos(Constant.ITEM_POS_ROLEPLAY_BUFF).getTemplate().getId() == 10844)
                        msg = Formulas.translateMsg(msg);
            ...
            default:
                ...
                if (!(nom.length() <= 1)) {
                    ...
                    Loggers.tchat.info(("Private"+ this.player.getName() + " à " + target.getName() + " > " + msg));
                    if (this.player.getObjetByPos(Constant.ITEM_POS_ROLEPLAY_BUFF) != null)
                        if (this.player.getObjetByPos(Constant.ITEM_POS_ROLEPLAY_BUFF).getTemplate().getId() == 10844)
                            msg = Formulas.translateMsg(msg);
        ...
        if (exchangeAction.getType() == ExchangeAction.BREAKING_OBJECTS && value instanceof BreakingObject) {
            ...
            for (Couple<Integer, Integer> couple : ((BreakingObject) value).getObjects()) {
                ...
                if (couple.second == object.getQuantity()) {
                    ...
                    World.world.removeGameObject(object.getId());
                    SocketManager.SEND_OR_DELETE_ITEM(this, object.getId());
                } else {
        ...
        if(this.player.getExchangeAction() != null && this.player.getExchangeAction().getType() == ExchangeAction.IN_MOUNTPARK) {
            ...
            switch (packet.charAt(2)) {
                case 'C':// Certificats -> Etable
                    ...
                    SocketManager.GAME_SEND_REMOVE_ITEM_PACKET(this.player, object.getId());
        ...
        switch(exchangeAction.getType()) {
            ...
            case ExchangeAction.IN_MOUNTPARK:
                ...
                for(GameObject object : objects)
                    player.removeItem(object.getId(), object.getQuantity(), true, true);
                break;
            ...
            case ExchangeAction.TRADING_WITH_COLLECTOR:
                ...
                for (Player loc : World.world.getGuild(collector.getGuildId()).getPlayers()) {
                    if (loc != null && loc.isOnline()) {
                        SocketManager.GAME_SEND_gITM_PACKET(loc, org.starloco.locos.game.entity.Collector.parseToGuild(loc.getGuild().getId()));
                        String str = "";
    ...
    private void removeTaxCollector(String packet) {
        ...
        for (Player z : this.player.getGuild().getPlayers()) {
            if (z.isOnline()) {
                SocketManager.GAME_SEND_gITM_PACKET(z, org.starloco.locos.game.entity.Collector.parseToGuild(z.getGuild().getId()));
                String str = "";
    ...
    private void placeTaxCollector() {
        ...
        for (Player player : guild.getPlayers()) {
            if (player != null && player.isOnline()) {
                SocketManager.GAME_SEND_gITM_PACKET(player, org.starloco.locos.game.entity.Collector.parseToGuild(player.getGuild().getId()));
                String str = "";
    ...
    private void dropObject(String packet) {
        ...
        Loggers.objects.debug("Dropping : " + this.player.getName() + " a jeté [" + obj.getTemplate().getId() + "@" + obj.getId() + ";" + qua + "]");
        SocketManager.GAME_SEND_Ow_PACKET(this.player);
        ...
        try {
            ...
            if (position == Constant.ITEM_POS_FAMILIER && object.getTemplate().getType() != Constant.ITEM_TYPE_FAMILIER && this.player.getObjetByPos(position) != null) {
                ...
                if (p.getEpo() == object.getTemplate().getId()) {
                    PetEntry pet = World.world.getPetsEntry(pets.getId());
                ...
                PetEntry MyPets = World.world.getPetsEntry(pets.getId());
                if (MyPets == null)
                    return;
            ...
            /* End feed pet **/
                ...
                if (object.getTemplate().getType() == 113) {
                    ...
                    SocketManager.send(this.player, "OR" + object.getId()); // on le pr�cise au client.
                    Database.getStatics().getObjectData().delete(object.getId());
                ...
                if (exObj != null)//S'il y avait d�ja un objet sur cette place on d�s�quipe
                {
                    ...
                    if ((obj2 = this.player.getSimilarItem(exObj)) != null)//On le poss�de deja
                    {
                        ...
                        World.world.removeGameObject(exObj.getId());
                        this.player.removeItem(exObj.getId());
                        SocketManager.GAME_SEND_REMOVE_ITEM_PACKET(this.player, exObj.getId());
                    } else
    ...
    private void feedObvi(String packet) {
        ...
        if (qua <= 1) {
            ...
            SocketManager.GAME_SEND_REMOVE_ITEM_PACKET(this.player, objVictime.getId());
        } else {
    ...
    private void leaveParty(String packet) {
        ...
        if (g == null)
            return;
        if (packet.length() == 2)//Si aucun id est sp�cifi�, alors c'est que le joueur quitte
        {
            g.leave(this.player);
