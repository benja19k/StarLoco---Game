package org.starloco.locos.game.world.world;
...
import org.starloco.locos.game.common.ConditionParser;
import org.starloco.locos.game.common.CryptManager;
...
import org.starloco.locos.core.network.login.transfer.DataQueue;
...
public class World {
    ...
    private Map<Short, org.starloco.locos.game.area.map.entity.MountPark> MountPark = new HashMap<>();
    ...
    private Map<Integer, org.starloco.locos.game.area.map.entity.Tutorial> Tutorial = new HashMap<>();
