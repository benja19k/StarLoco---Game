...
import org.starloco.locos.game.entity.monster.Monster.MobGrade;
...
import org.starloco.locos.game.fight.Challenge;
    ...
    public void command(String command, String[] infos, String msg) {
        if (command.equalsIgnoreCase("CHALL")) {
            ...
            for (Entry<Integer, Integer> obj : perso.getStoreItems().entrySet()) {
                ...
                mess = entry.getId() + " || " + entry.getTemplate().getName()
                        + " || " + entry.getQuantity();
                this.sendMessage(mess);
            }
