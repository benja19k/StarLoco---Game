package org.starloco.locos.game.other;
...
import org.starloco.locos.game.area.map.entity.Tutorial;
        ...
        switch (id) {
            ...
            case 50: //Traque
                ...
                if (player.get_traque().getTime() < System.currentTimeMillis() - 600000 || player.get_traque().getTime() == 0) {
                    ...
                    if(object != null)
                        player.removeItem(object.getId(), player.getNbItemTemplate(10085), true, true);
