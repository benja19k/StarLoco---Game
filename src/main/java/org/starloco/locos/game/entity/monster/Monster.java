package org.starloco.locos.game.entity.monster;
...
import org.starloco.locos.game.entity.monster.boss.MaitreCorbac;
...
public class Monster {
    ...
    public static class MobGroup {
        ...
        public ArrayList<GameObject> getObjects() {
            if(this.objects == null && Config.INSTANCE.isHeroic())
                this.objects = new ArrayList<>();
            else if(!Config.INSTANCE.isHeroic())
