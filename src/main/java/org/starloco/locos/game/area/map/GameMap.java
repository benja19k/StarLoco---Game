...
import org.starloco.locos.game.entity.npc.NpcMovable;
    ...
    public void onPlayerArriveOnCell(Player player, int id) {
        ...
        synchronized (cell) {
            ...
            if (obj != null && !Main.INSTANCE.getMapAsBlocked()) {
                Loggers.objects.debug("Object", "GetInOnTheFloor : {} a ramassé [{}@{}*{}]",
                        player.getName(), obj.getTemplate().getId(), obj.getId(), obj.getQuantity());
