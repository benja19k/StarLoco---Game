...
public class French extends AbstractLang {
    ...
    public void initialize() {
        ...
        this.sentences.add(index, "Les commandes disponnibles sont :\n"
                ...
                (Config.INSTANCE.isTeamMatch() ? "<b>.kolizeum</b> - Vous inscrit/désincrit de la liste d'attente de Kolizeum.\n" : "") +
                (Config.INSTANCE.isDeathMatch() ? "<b>.deathmatch</b> - Vous inscrit/désincrit de la liste d'attente de DeathMatch.\n" : "") +
